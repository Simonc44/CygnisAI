...
>(
  (
    ...
    if (isMobile || collapsible === 'offcanvas') {
      ...
      return (
        <Sheet open={isMobile ? openMobile : open} onOpenChange={handleOpenChange} {...props}>
          <SheetContent
          ...
          >
             <SheetHeader className="sr-only">
              <SheetTitle>CygnisAI Navigation</SheetTitle>
              <SheetDescription>
                Select a chat or start a new one. Explore other features like Gems and Storybook.
              </SheetDescription>
            </SheetHeader>
